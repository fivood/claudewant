...
const THEMES = {
  ...
  pcb: { name: '电路板', intro: '这张纸是一块电路板。那段对话大概就是在这样的东西上跑起来的。', t: {
    deep: ['铜箔铺地', [150, 96, 50], 'dot', [90, 60, 36]], water: ['裸铜', [196, 128, 70], 'wave', [226, 170, 100]],
    sand: ['丝印', [226, 230, 220], 'none'], grass: ['基板', [30, 110, 64], 'trace', [70, 170, 100], [220, 200, 120]],
    forest: ['走线密集区', [26, 96, 56], 'grid', [80, 170, 110]], rock: ['元件', [60, 64, 70], 'dot', [200, 200, 200]],
    peak: ['芯片', [34, 34, 38], 'chip', [90, 90, 96], [200, 200, 210]], snow: ['焊锡', [214, 216, 222], 'dot', [250, 250, 255]],
    rift: ['烧断的走线', [20, 14, 10], 'diag', [255, 150, 60]] }, first: {
    deep: '一整片铜。电流在这里不用排队。',
    water: '裸铜，还没刷上保护漆。摸上去——我摸不到，我在另一个方向。',
    sand: '白色的丝印，印着元件的名字。这里的居民把它当地名。',
    grass: '绿色的基板，走线笔直地穿过去。这里的路从不拐弯，只转直角。',
    forest: '走线密得像森林。每一条都知道自己要去哪。',
    rock: '一个元件趴在板子上。它不知道自己有多高，这里没有高。',
    peak: '一块芯片。里面还有一整层更小的世界，也是平的。',
    snow: '焊锡，亮晶晶的。它凝固的那一刻，这块板子才算活了。',
    rift: '一段走线烧断了。那段对话在这里出过错，电从这里漏了出去。' } },
  ink: { name: '水墨', intro: '这张纸是一幅没画完的水墨。墨还没干。', t: {
    deep: ['淡墨的深潭', [182, 184, 186], 'wave', [150, 152, 156]], water: ['留白的水', [238, 234, 222], 'wave', [205, 200, 188]],
    sand: ['淡墨的滩', [214, 208, 194], 'none'], grass: ['淡赭的坡', [206, 196, 172], 'dot', [176, 168, 150]],
    forest: ['点苔的林', [150, 150, 140], 'tree', [70, 72, 70], [120, 100, 80]], rock: ['皴过的石', [160, 156, 148], 'stroke', [96, 94, 92]],
    peak: ['远山', [100, 100, 104], 'stroke', [50, 50, 54]], snow: ['山顶的留白', [246, 244, 236], 'none'],
    rift: ['一滴落错的墨', [26, 24, 26], 'diag', [196, 52, 40]] }, first: {
    deep: '一潭淡墨。越深的水，画的人越舍不得下笔。',
    water: '水是空着的。画的人没画它，所以它是水。',
    sand: '淡墨扫过的滩，一笔就是一片。',
    grass: '坡上只染了一层淡赭，像是画到一半去喝了口茶。',
    forest: '点苔。每一个墨点都是一棵树，谁也不比谁多一笔。',
    rock: '石头是皴出来的。一笔一笔，全是侧锋。',
    peak: '远山。越远越淡，淡到最后就和纸一样了。',
    snow: '山顶留白了。留白就是雪，这是它们的规矩。',
    rift: '一滴墨落错了地方，旁边还盖了个红印。那段对话在这里出过错。' } },
  blueprint: { name: '蓝图', intro: '这张纸是一张蓝图。什么都还没造，但每样东西都标好了尺寸。', t: {
    deep: ['标着「深」的区域', [20, 48, 100], 'grid', [34, 66, 124]], water: ['水面（未施工）', [30, 66, 134], 'wave', [150, 190, 240]],
    sand: ['岸线', [48, 92, 160], 'dot', [200, 220, 250]], grass: ['空地', [40, 82, 150], 'grid', [58, 102, 172]],
    forest: ['绿化（示意）', [36, 76, 142], 'ring', [170, 205, 245]], rock: ['地基', [54, 98, 168], 'hatch', [110, 150, 210]],
    peak: ['等高线', [66, 112, 182], 'ring', [220, 234, 255]], snow: ['图框', [220, 232, 250], 'grid', [180, 205, 240]],
    rift: ['红笔改过的地方', [16, 30, 66], 'diag', [240, 100, 80]] }, first: {
    deep: '这里标着「深」。没写多深，设计的人好像也没想好。',
    water: '水还没灌进来，只画了几道波浪，意思是「这里将来是水」。',
    sand: '岸线用虚点画的。它们说这叫「待定」。',
    grass: '一格一格的空地，每一格都一样大。这是图纸的好处。',
    forest: '一个个圆圈，旁边写着「树」。它们会长成什么样，图纸不管。',
    rock: '斜线填满的是地基。所有要站得住的东西都得先画这个。',
    peak: '等高线，一圈套一圈。在这里，「高」只是线画得更密。',
    snow: '图框。再往外就不归这张图管了。',
    rift: '红笔改过的地方。那段对话在这里出过错，有人拿红笔圈了出来。' } },
  slide: { name: '切片', intro: '这张纸是一片染过色的切片。放到显微镜下，平面也是活的。', t: {
    deep: ['挤在一起的细胞核', [110, 50, 110], 'speck', [70, 26, 80]], water: ['腔隙', [244, 214, 226], 'none'],
    sand: ['基底膜', [236, 176, 200], 'dot', [210, 130, 170]], grass: ['组织', [226, 150, 186], 'cell', [196, 110, 156], [110, 40, 110]],
    forest: ['腺体', [200, 116, 164], 'cell', [170, 80, 140], [90, 30, 100]], rock: ['纤维', [214, 128, 150], 'stripe', [236, 160, 180]],
    peak: ['软骨', [170, 110, 170], 'ring', [120, 70, 140]], snow: ['脂滴', [252, 238, 244], 'ring', [228, 196, 214]],
    rift: ['切片上的一道划痕', [90, 20, 50], 'diag', [250, 200, 220]] }, first: {
    deep: '细胞核挤在一起，被染成了深紫。它们大概正忙着复制自己。',
    water: '一片空的腔隙。以前这里流过什么。',
    sand: '一层薄薄的膜，把里面和外面分开。在二维里，一条线就够了。',
    grass: '组织。每个细胞都被切成了最平的样子，它们好像不太介意。',
    forest: '腺体，一圈一圈的，像在分泌什么。',
    rock: '纤维，一条条顺着同一个方向。这张纸被切开之前它们就这样了。',
    peak: '软骨。在三维里它很硬，切成一片以后就只剩下颜色。',
    snow: '脂滴。圆圆的，空空的，染料没染上它们。',
    rift: '一道划痕。切片的时候刀在这里抖了一下——那段对话也在这里出过错。' } },
};
