...
const MUSE = [
  ...
  tr('我迈一步，世界就多一格。这不是我造的，只是之前没人看。', 'Every step I take, the world gains a tile. I didn\'t make it. Nobody had looked before.'),
  tr('空白不是没有，是还没被看见。', 'Blank doesn\'t mean nothing. It means not seen yet.'),
