...
- **深空**：不导入会话直接开始的纸是透明的，展开的地方能看见背后的真实天空。视角和比例尺都随机：有时是一大片星图（银河按真实银道坐标画），有时像望远镜对准某个天体放大到几百格。六十多个有名的星系、星云、星团和亮星放在真实的位置上，颜色照哈勃和韦布的照片调，亮星带韦布的六条星芒；走到跟前 Clawd 会说说它的来历，名字标在图上。深空不分昼夜。
...
- **全图**可以把整张纸铺开下载成 PNG，还能看这段对话的四维投影。
