...
- **Pet = Lineland**: on the paper Clawd is solid, turning, stepping, swinging its arms and leaning as it walks, and turning back to face you when it stops; as a desktop pet, Clawd is flat too and the world collapses into a line. Wonders in the way get climbed, launched over, walked through (the forge), or stepped around through the fourth dimension.
